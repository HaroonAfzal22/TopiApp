...
enum Availability { loading, available, unavailable,name }

class InAppReviews extends StatefulWidget {
  @override
  _InAppReviewsState createState() => _InAppReviewsState();
}

class _InAppReviewsState extends State<InAppReviews> {
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Column(
          ...
          children: [
            Text('In App Review status: ${Availability.name}'),
            TextField(
